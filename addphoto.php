...
$id1=$_SESSION['id'];
    ...
    $image=basename( $_FILES["image"]["name"],".jpg"); // used to store the filename in a variable
       ...
       $image=$_FILES["image"]["name"];
        ...
        $sql="INSERT INTO portfolio VALUES ('$id1','$image')";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <button class="btn btn-info waves-effect waves-light"  type="button" data-toggle="modal" data-target="#addnew"><span class="btn-label"><i class="ti-plus"></i></span>Add New Photo</button>
                ...
                <!-- Modal For New Registration-->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="exampleModalLabel1">Add New Photo</h4>
                            ...
                            <form class="form-horizontal m-t-40" id="myForm"action="addphoto.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class= "col-lg-3">
                                <input type="submit" class="btn btn-rounded btn-success" id="#btn-submit "name="submit" value="Send">
                                <br>
                                <br>
                            </form>
                        </div>
