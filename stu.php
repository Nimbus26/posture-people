...
<body class="fix-header fix-sidebar card-no-border">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title"><a href="menu.php"><b>Attendence List</b></a></h2>
    ...
    <?php                                    $fetch=mysqli_query($conn,"SELECT * from attendence16 ")or die(mysqli_error());
